...
### Point System
- **MON Token Conversion**: Users deposit MON which converts to platform points
...
- **Transparent Exchange Rate**: Clear conversion rates between MON tokens and platform points
...
- **Points Management Contract**: Handles MON token/point conversion
...
GG MONAD follows a modular architecture with clear separation of concerns:
...
- **Blockchain Interface**: API for interacting with Monad blockchain
